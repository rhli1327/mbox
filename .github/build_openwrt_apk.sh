...
install -Dm644 "$PROJECT/release/config/openwrt.conf" "$ROOT_DIR/etc/config/mbox"
install -Dm755 "$PROJECT/release/config/openwrt.init" "$ROOT_DIR/etc/init.d/mbox"
install -Dm644 "$PROJECT/release/config/openwrt.keep" "$ROOT_DIR/lib/upgrade/keep.d/mbox"
